  ...
  return (
    <div className="flex items-center gap-2">
      <ContentCopyable
        ...
        disabled={isLoading}
      />
      {isAiMessage && showRequestConsultation && !!onRequestConsultation && (
        <Button
          type="button"
          variant="outline"
          size="sm"
          ...
          className="gap-2 rounded-lg border-2 border-primary/50 bg-primary/10 text-primary font-semibold text-sm px-4 py-2 h-9 shadow-md hover:bg-primary/20 hover:border-primary/70 hover:shadow-lg transition-all duration-200"
        >
          <TicketPlus className="size-4 shrink-0" strokeWidth={2.25} />
